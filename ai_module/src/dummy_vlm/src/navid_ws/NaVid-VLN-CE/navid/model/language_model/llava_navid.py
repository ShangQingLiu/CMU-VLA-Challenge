...
AutoConfig.register("llava", LlavaConfig)
llava_path = vision_tower = _PROJECT_ROOT / "model_zoo" / "models--liuhaotian--llava-llama-2-13b-chat-lightning-preview" \
/ "snapshots" / "bcda0227a7f371117a195ef0af88c1616a830520"

#model = LlavaLlamaForCausalLM.from_pretrained("liuhaotian/llava-llama-2-13b-chat-lightning-preview")
model = LlavaLlamaForCausalLM.from_pretrained(llava_path)
